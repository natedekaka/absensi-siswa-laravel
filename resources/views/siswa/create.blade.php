...
<head>
    ...
    <title>Tambah Siswa - Absensi Siswa</title>
                            ...
                            <form method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="nama" class="form-control" placeholder="Nama siswa" value="{{ old('nama') }}" required>
                                    </div>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <div class="row g-2">
                                        <div class="col-6">
                                            <label class="gender-option d-block @if(old('jenis_kelamin') == 'Laki-laki') selected @endif" id="gender-laki">
                                                <input type="radio" name="jenis_kelamin" value="Laki-laki" class="d-none" @if(old('jenis_kelamin') == 'Laki-laki') checked @endif required>
                                                <i class="fas fa-male d-block text-primary"></i>
                                                <span class="small">Laki-laki</span>
                                            </label>
                                        </div>
                                        <div class="col-6">
                                            <label class="gender-option d-block @if(old('jenis_kelamin') == 'Perempuan') selected @endif" id="gender-perempuan">
                                                <input type="radio" name="jenis_kelamin" value="Perempuan" class="d-none" @if(old('jenis_kelamin') == 'Perempuan') checked @endif>
